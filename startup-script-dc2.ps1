...
function Set-UACStatus {
  ...
  .NOTES
    ...
    Credits(s)    	: Pat Richard (pat@innervation.com)
...
Configuration RegisterNode
{
  ...
  .EXAMPLE
    RegisterScDc1 -OutputPath 'C:\Users\Public\dsc'

    Description
    -----------
    Runs the DSC configuration and places the resulting MOF into a known good and always available path.
  #>
  param (
...
RegisterNode -ComputerName 'sc-dc2' -OutputPath 'C:\Users\Public\dsc'
